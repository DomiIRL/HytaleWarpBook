...
public class BindWarpPageTeleporterInteraction extends SimpleBlockInteraction {

  public static final BuilderCodec<BindWarpPageTeleporterInteraction> CODEC =
    BuilderCodec.builder(
        BindWarpPageTeleporterInteraction.class,
        BindWarpPageTeleporterInteraction::new,
