...
public class OpenWarpBookInteraction extends SimpleInstantInteraction {
    ...
    protected void firstRun(
        ...
        if (heldItem == null || !heldItem.getItemId().equals("Warp_Book")) {
            context.getState().state = InteractionState.Failed;
            return;
        }
        ...
        player.getWorld().execute(() -> {
            ...
            ItemStackItemContainer container = WarpBookInventory.ensureWarpBookContainer(hotbarContainer, heldItemSlot);
            if (container == null) {
                return;
            }
